...
|:---------|:-------------------:|:------------------------------------------------------------------------|
| **StPlayer** |  v3.0.2 | [SetupStPlayer.zip](https://github.com/impleotv/stplayer-release/releases/v3.0.2/download/SetupStPlayer.zip) | 


*Released on Wed, 20 May 2026, 19:21 GMT+3*
